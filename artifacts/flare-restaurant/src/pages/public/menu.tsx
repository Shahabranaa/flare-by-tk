  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="text-muted-foreground text-lg">Fire-grilled perfection. Choose from our premium selection of authentic Pakistani delicacies.</p>
      </div>
      ...
      {itemsLoading ? (
              ...
              <div className="group flex flex-col h-full bg-card rounded-2xl border border-border overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-primary/30 cursor-pointer">
                ...
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <h3 className="font-heading font-bold text-lg leading-tight group-hover:text-primary transition-colors">{item.name}</h3>
                  </div>
        ...
        <div className="text-center py-20 bg-muted/30 rounded-2xl">
          <p className="text-lg text-muted-foreground">No menu items found matching your criteria.</p>
          <Button variant="outline" className="mt-4" onClick={() => { setActiveCategoryId(null); setSearchQuery(""); }}>
            Clear Filters
          </Button>
        </div>
      )}
